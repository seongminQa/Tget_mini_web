    ...
    <div class="content" style="background-color: white; width: 100%">
      <div class="row justify-content-center ">
        <div class="pt-3 pb-3 row align-items-stretch" style="width: 45%">
          ...
          <div class="col-9 ps-5 pe-5" style="background-color: white; border-radius: 10px;">
            <h5 class="ps-2 pt-5"><strong>회원 정보 수정</strong></h5>
            ...
            >
              <div class="div_form row">
                <div class="col-3"><strong>아이디</strong></div>
                <div class="col-8">kosa123123</div>
              </div>
              <div class="div_form row">
                <div class="col-3"><strong>비밀번호</strong></div>
                <div class="col-7"></div>
                <div class="col-2">
                  <button
                    type="button"
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="p-3" method="post">
              <div class="div_form row">
                <label for="pw" class="col-3"><strong>비밀번호</strong></label>
                <input
                  class="col-7 mb-5"
                  type="password"
                  id="pw"
                ...
                <div class="col-2">
                  ...
                  >
                    <img
                      src="/Tget_mini_web/resources/image/project_image/eye.svg"
                      style="width: 30px"
                    />
                  </button>
                </div>
              ...
              <div class="div_form row">
                <label for="pwcheck" class="col-3"
                  ><strong>비밀번호 확인</strong></label
                >
                <input
                  class="col-7 mb-5"
                  type="password"
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="p-3" method="post">
              <div class="div_form row">
                <label for="nickname" class="col-3"
                  ><strong>닉네임</strong></label
                >
                <input
                  class="col-9 mb-5"
                  type="text"
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="p-3" method="post">
              <div class="div_form row">
                <label for="email" class="col-3"><strong>이메일</strong></label>
                <input
                  class="col-9 mb-5"
                  type="text"
                  id="email"
      ...
      <div class="modal-dialog modal-l">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="p-3" method="post">
              <div class="div_form row">
                <label for="address" class="col-3"><strong>주소</strong></label>
                <input
                  class="col-9 mb-5"
                  type="text"
                  id="address"
              ...
              <div class="div_form row">
                <label for="address" class="col-3"
                  ><strong>상세주소</strong></label
                >
                <input
                  class="col-9 mb-5"
                  type="text"
      ...
      <div class="modal-dialog modal-l">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="p-3" method="post">
              <div class="div_form row">
                <label for="phone" class="col-3"
                  ><strong>전화번호</strong></label
                >
                <input
                  class="col-9 mb-5"
                  type="text"
