	...
	<%@include file="/WEB-INF/views/common/header.jsp"%>
	   	...
	   	<div class="container" style="height: 100px; width: 100%;  margin-top:50px; ">
  			<!-- border:1px solid black; -->
				...
				<!-- 예매자 창 -->
				<div  class="col-lg-7">	
					<div style="width: 100%; height:450px;  word-spacing: 0.5em; ">	<!--border:1px solid black; float: right; -->	
  	  		...
  	  		<!-- 예매번호 창 -->
	  	  		<div style="width:100%; height:150px;  padding:10px; "><!--border:1px solid red;  -->
	  	  		<table class="table">
