                  ...
                  <div class="card-body">
                      ...
                      <form id="updateBoardForm" method="post" action="updateBoard" enctype="multipart/form-data">
                      	<div class="input-group">
                           ...
                           <input id="bno" type="text" name="bno" class="form-control" readonly value="${boardDto.bno}"/>
                        </div>
                        <div class="input-group">
                           <div class="input-group-prepend"><span class="input-group-text">btitle</span></div>
                           <input id="btitle" type="text" name="btitle" class="form-control" value="${boardDto.btitle}">
                        </div>
                        ...
                        <div class="mt-3">
                           ...
                           <a class="btn btn-info btn-sm" href="javascript:window.history.back()">목록</a>
                        </div>
                     </form>
