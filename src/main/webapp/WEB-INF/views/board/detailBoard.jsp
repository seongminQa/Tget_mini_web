           ...
           <div class="d-flex row">
            ...
            <div class="card">
               ...
               <div class="card-body">
                   ...
                   <a href="javascript:window.history.back()" class="btn btn-info btn-sm">목록</a>
                   <a href="updateBoardForm?bno=${boardDto.bno}" class="btn btn-info btn-sm">수정</a>
                   <a href="deleteBoard?bno=${boardDto.bno}" class="btn btn-info btn-sm">삭제</a>
               </div>
            </div>
                 <!-- ###################################### -->
                  </div>
